          ...
          <div className="flex items-center">
            {loading ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm sm:text-base font-medium text-white bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 rounded-lg transition-colors"
                aria-label="Logout"
              >
